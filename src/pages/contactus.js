                    ...
                    <div>
                        <div className="flex items-center justify-center mx-8">
                            <div>
                                ...
                                <IoLocationOutline className="text-3xl font-bold transition-all duration-500 ease-in-out transform hover:text-gray-500 hover:h-16 hover:text-4xl"/>
                                <h2>Address: <span>Islamabad Pakistan</span></h2>
                                </a>

                            </div>
                            <div><a href="https://wa.me/923175566089" target='_blank' rel="noreferrer" >
                            <FaPhoneAlt className="text-3xl font-bold transition-all duration-500 ease-in-out transform hover:text-gray-500 hover:h-16 hover:text-4xl"/>
                            <h2>+923175566089</h2>
                            </a>
                            ...
                            <div>
                                ...
                                <IoLogoInstagram className="text-3xl font-bold transition-all duration-500 ease-in-out transform hover:text-gray-500 hover:h-16 hover:text-4xl"/>
